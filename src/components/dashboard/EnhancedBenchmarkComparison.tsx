      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription className="text-xs md:text-sm">
            Compare your concept against top 5 competitors • Click any product for details
          </CardDescription>
        </CardHeader>
        <CardContent className="px-2 md:px-6">
          <ScrollArea className="w-full whitespace-nowrap">
            <div className="flex gap-2 md:gap-3 pb-4">
              ...
              {/* Competitor Columns - Clickable */}
              {topProducts.map((product, idx) => (
                <div 
                  key={product.id} 
                  className="w-[180px] md:w-[200px] lg:w-[220px] shrink-0 rounded-lg border border-border bg-card overflow-hidden cursor-pointer transition-all hover:border-primary hover:shadow-md"
